...
k=document.getElementById("gameArea"),l=document.getElementById("gameScreen"),
...
U.prototype.f=function(){return this.a+this.height/2};
function ka(){
    this.c=this.i=0;
this.h=!1;
...
ka.prototype.f=function(){return this.b+this.height/2};
function la(){
    D=0;
    Q.volume=1;
    650>ma()&&(k.style.width=.98*ma()+"px");
    480>na()?(k.style.height=.98*na()+"px",
    w=15*k.offsetHeight/480):
    w=15;
    ...
    if("ontouchstart"in window||navigator.maxTouchPoints||0<navigator.msMaxTouchPoints)C=.25,h.appendChild(document.getElementById("soundButtonWrapper")),W(!0)}b("ShowMainScreen",la);
    function qa(){
        ha.innerHTML=S+" OF "+T}b("SwitchSound",function(){r=!r;ra()});
        function ra(){document.getElementById("soundButton").classList.remove("soundOn");
    ...
    function W(a){
        D=1;
        (B=a)?(document.getElementById("easyDifficultyButton").innerHTML='<span class="buttonKey">(e)&nbsp;</span>Easy',document.getElementById("hardDifficultyButton").innerHTML='<span class="buttonKey">(h)&nbsp;</span>Hard'):(document.getElementById("easyDifficultyButton").innerHTML='<span class="buttonKey">(s)&nbsp;</span>Slow',document.getElementById("hardDifficultyButton").innerHTML='<span class="buttonKey">(f)&nbsp;</span>Fast');
        ca.style.display=B?"block":"none";
        da.style.display=B?
        "none":"block";
        .25==C?X(.25):B?(f.style.display="none",l.style.display="none",p.style.display="none",g.style.display=B?"flex":"none",h.style.display=B?"none":"flex"):X(0)
    }
    ...
    function X(a){
        ...
        1==C?m.addEventListener("mousemove",ta):.25==C&&(m.addEventListener("touchstart",ua),m.addEventListener("touchend",va));
        ...
        function wa(){
            ...
            switch(ia){
                ...
                x=.16;
                break;
                default:A=B?8:10,E=B?11:10,x=.13
            }
            A+=z;
            e=new ka;
            v=5*w;
        ...
        function xa(){
            if(!L){
                ...
                B&&(I.a+=(e.f()-I.f())*x);
                I.a+=I.b;J.a+=J.b;I.a<w?I.a=w:I.a>t&&(I.a=t);
                ...
                u=e.g?e.a
                <J.c+J.width&&e.a+e.width>
                J.c&&e.b
                <J.a+J.height&&e.b+e.height>
                J.a?e.a>
                J.c+J.width/2?1:2:0:e.a
                <I.c+I.width&&e.a+e.width>
                I.c&&e.b
                <I.a+I.height&&e.b+e.height>
                I.a?e.a+e.width
                <I.c+I.width/2?1:2:0;
                if(0!=u){
                    if(2==u){
        ...
        function ta(a){
            1==C&&K&&(a=a.clientY-R,a
                <w?J.a=w:J.a=a>
                m.height-w?m.height-w:a)
            }
            
            document.addEventListener("keydown",function(a){
                var c=a.which||a.keyCode;3==D&&0==C?(38===c?(J.b=-A,a.preventDefault()):40===c&&(J.b=A,a.preventDefault()),83!==c||B)?88!==c||B||(I.b=A):I.b=-A:0==D?49===c?W(!0):50===c&&W(!1):1==D?77===c?X(1):75===c&&X(0):2==D?69===c||83==c?Y(0):77===c?Y(1):(72===c||70==c)&&Y(2):4==D&&82===c&&wa()});

            document.addEventListener("keyup",function(a){a=a.which||a.keyCode;
                27===a&&(K&&ya(0),la());
                ...
                function va(a){
                    ...
                    function Z(){
                        ...
                        O?
                        document.getElementById("serve1").classList.add("selected")
                        :
                        document.getElementById("serve0").classList.add("selected");
                        -3==z?
                        document.getElementById("sense0").classList.add("selected")
                        :0==z?
                        document.getElementById("sense1").classList.add("selected")
                        :3==z&&
                        document.getElementById("sense2").classList.add("selected");
                        0==P?
                        document.getElementById("starts0").classList.add("selected")
                        :1==P?
                        document.getElementById("starts1").classList.add("selected")
                        :2==P&&
                        document.getElementById("starts2").classList.add("selected")
                    }
                    b("OpenOptions",Z);
                    ...
                    function ma(){
                        return null!=window.innerWidth?window.innerWidth:
                        null!=document.body?document.body.clientWidth:
                        null
                    }
                    function na(){
                        return null!=window.innerHeight?window.innerHeight:
                        null!=document.documentElement?document.documentElement.clientHeight:document.body.clientHeight
                    };
